    ...
    App = (function(_super) {
      ...
      */
      ...
      App.prototype.onrequest = function(e, url, options) {
        var cls, loadFn, match, request, self, view;
        ...
        if (self.currentView && self.currentView.started) {
      ...
      */
      ...
      App.prototype._match = function(url) {
        var matches, param, path, request, route, self, view, _i, _j, _len, _len1, _ref, _ref1;
        self = this;
