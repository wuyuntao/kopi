  ...
  define("kopi/db/adapters/kv", function(require, exports, module) {
    ...
    */
    ...
    KeyValueAdapter = (function(_super) {
      ...
      KeyValueAdapter.name = 'KeyValueAdapter';
      ...
      KeyValueAdapter.prototype.create = function(query, fn) {
        ...
        if (!pk) {
          if (fn) {
            fn(true, "Must provide primary key");
          }
          return self;
        }
        ...
        if (isKeyExists) {
          if (fn) {
            fn(true, "Primary key already exists.");
          }
          return self;
        }
      ...
      KeyValueAdapter.prototype.retrieve = function(query, fn) {
        ...
        if (value) {
          try {
            if (fn) {
              fn(null, [self._modelObject(value, model.meta().names)]);
            }
          } catch (e) {
            if (fn) {
              fn("Failed to parse value: " + e);
            }
          }
        } else {
          if (fn) {
      ...
      KeyValueAdapter.prototype.update = function(query, fn) {
        var retrieveFn, self;
        self = this;
        retrieveFn = function(error, message) {
          var key, model, value;
          if (error) {
            if (fn) {
              fn(error, message);
          ...
          if (value) {
            ...
            if (fn) {
              return fn(true, "Entry not found");
            }
          }
        };
      ...
      */
      ...
      KeyValueAdapter.prototype._get = function(store, key, value, fn) {
      ...
      */
      ...
      KeyValueAdapter.prototype._set = function(store, key, value, fn) {
        throw new exceptions.NotImplementedError();
      };
      ...
      */
      ...
      KeyValueAdapter.prototype._remove = function(store, key, fn) {
        throw new exceptions.NotImplementedError();
      };
