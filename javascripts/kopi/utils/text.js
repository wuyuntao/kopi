...
(function() {
  ...
  define("kopi/utils/text", function(require, exports, module) {
    var ABERRANT_PLURAL_MAP, StringProto, VOWELS, camelize, capitalize, constantize, contains, dasherize, endsWith, format, isString, isWhitespace, lowerCaseFn, lowercase, pluralize, reFirstLetter, reLeading, reLower, reSymbol, reTrailing, reUnderscore, reUpper, startsWith, strDash, strSymbol, strUnderscore, trim, truncate, underscore, upperCaseFn, whiteSpaces;
