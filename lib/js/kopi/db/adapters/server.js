(function() {
  ...
  define("kopi/db/adapters/server", function(require, exports, module) {
    var $, ServerAdapter, base, logger, logging, _ref;
    ...
    ServerAdapter = (function(_super) {
      var action, kls, proto, requestFn, _i, _len, _ref1;

      __extends(ServerAdapter, _super);

      function ServerAdapter() {
        _ref = ServerAdapter.__super__.constructor.apply(this, arguments);
        return _ref;
      }
