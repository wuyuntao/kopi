(function() {
  ...
  define("kopi/db/errors", function(require, exports, module) {
    var AdapterNotFound, DoesNotExist, ModelError, ModelNameDuplicated, PrimaryAdapterNotFound, PrimaryKeyDuplicated, PrimaryKeyNotFound, RelatedModelNotFetched, exceptions, _ref;
    ...
    DoesNotExist = (function(_super) {
      ...
      function DoesNotExist() {
        _ref = DoesNotExist.__super__.constructor.apply(this, arguments);
        return _ref;
      }
