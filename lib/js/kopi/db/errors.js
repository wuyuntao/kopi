...
(function() {
  ...
  define("kopi/db/errors", function(require, exports, module) {
    ...
    PrimaryAdapterNotFound = (function(_super) {
      ...
      PrimaryAdapterNotFound.name = 'PrimaryAdapterNotFound';
    ...
    AdapterNotFound = (function(_super) {
      ...
      AdapterNotFound.name = 'AdapterNotFound';
    ...
    ModelNameDuplicated = (function(_super) {
      ...
      ModelNameDuplicated.name = 'ModelNameDuplicated';
    ...
    PrimaryKeyDuplicated = (function(_super) {
      ...
      PrimaryKeyDuplicated.name = 'PrimaryKeyDuplicated';
    ...
    PrimaryKeyNotFound = (function(_super) {
      ...
      PrimaryKeyNotFound.name = 'PrimaryKeyNotFound';
    ...
    RelatedModelNotFetched = (function(_super) {
      ...
      RelatedModelNotFetched.name = 'RelatedModelNotFetched';
