(function() {
  ...
  define("kopi/db/queries", function(require, exports, module) {
    var ACTIONS, ALL, BaseQuery, BaseRetriveQuery, COUNT, CREATE, CreateQuery, DESTROY, DestroyQuery, EQ, GT, GTE, ILIKE, IN, IS, LIKE, LIMIT, LT, LTE, NE, NIN, ONE, ONLY, QueryError, RAW, RETRIEVE, RawQuery, RetrieveQuery, SKIP, SORT, UPDATE, UpdateQuery, WHERE, array, exceptions, klass, number, object, utils, _ref;
    ...
    */
    ...
    BaseQuery = (function() {
      ...
      function BaseQuery(model, criteria) {
        var cls, method, self, _i, _len, _ref1;
      ...
      BaseQuery.prototype.criteria = function() {
        var cls, criteria, method, self, value, _i, _len, _ref1;
