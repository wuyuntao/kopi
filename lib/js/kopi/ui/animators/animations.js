(function() {
  ...
  define("kopi/ui/animators/animations", function(require, exports, module) {
    var Animation, EventEmitter, WEBKIT_TRANSITION_END_EVENT, exceptions, klass;
    EventEmitter = require("kopi/events").EventEmitter;
    klass = require("kopi/utils/klass");
    exceptions = require("kopi/exceptions");
    WEBKIT_TRANSITION_END_EVENT = require("kopi/utils/events").WEBKIT_TRANSITION_END_EVENT;
    /*
    ...
    Animation = (function(_super) {
      ...
      */
      ...
      Animation.prototype.animate = function(from, to, options, fn) {
        var animationClass, animationReverseClass, animatorClass, animatorElement, cls, endTransitionFn, fromElement, fromStartClass, fromStopClass, isEnded, isReverse, self, startTransitionFn, toClass, toElement, toStartClass, toStopClass;
        if (options == null) {
          options = {};
        }
        ...
        startTransitionFn = function() {
          ...
          return toElement.one(WEBKIT_TRANSITION_END_EVENT, function(e) {
            e.preventDefault();
            e.stopPropagation();
            return endTransitionFn();
          });
        };
