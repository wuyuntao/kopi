  ...
  define("kopi/ui/clickable", function(require, exports, module) {
    ...
    */
    ...
    Clickable = (function(_super) {
      ...
      Clickable.DOUBALE_CLICK_EVENT = "click";
      ...
      Clickable.prototype.delegate = function() {
        var mouseOutFn, mouseOverFn, preventDefault, self, stopPropagation;
        ...
        return self.element.bind(Clickable.eventName(events.MOUSE_OVER_EVENT), mouseOverFn);
      };
