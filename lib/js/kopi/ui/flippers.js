(function() {
  ...
  define("kopi/ui/flippers", function(require, exports, module) {
    var Animation, Animator, Flippable, Flipper, FlipperAnimation, FlipperPage, Scrollable, Widget, klass, logger, logging, math, number, _ref;
    ...
    */
    ...
    FlipperPage = (function(_super) {
      ...
      function FlipperPage() {
        _ref = FlipperPage.__super__.constructor.apply(this, arguments);
        return _ref;
      }
    ...
    */
    ...
    Flipper = (function(_super) {
      ...
      Flipper.prototype.onresize = function() {
        var cls, flippable, page, _i, _len, _ref1;
