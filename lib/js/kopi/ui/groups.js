(function() {
  ...
  define("kopi/ui/groups", function(require, exports, module) {
    var Group, array, exceptions, klass, logger, logging, widgets;
    ...
    Group = (function(_super) {
      ...
      */
      ...
      Group.prototype.onskeleton = function() {
        Group.__super__.onskeleton.apply(this, arguments);
        return this._skeletonChildren();
      };

      Group.prototype.onrender = function() {
        Group.__super__.onrender.apply(this, arguments);
        return this._renderChildren();
      };

      Group.prototype.ondestroy = function() {
        Group.__super__.ondestroy.apply(this, arguments);
        return this._destroyChildren();
      };

      Group.prototype._skeletonChildren = function() {
        var child, wrapper, _i, _len, _ref;
      ...
      Group.prototype._destroyChildren = function() {
        var child, _i, _len, _ref;
