(function() {
  ...
  define("kopi/ui/navigation", function(require, exports, module) {
    var $, Animation, Animator, Button, Nav, NavButton, Navbar, Text, Widget, app, i18n, klass, settings, text, utils, _ref;
    ...
    NavButton = (function(_super) {
      ...
      function NavButton() {
        _ref = NavButton.__super__.constructor.apply(this, arguments);
        return _ref;
      }
    ...
    */
    ...
    Nav = (function(_super) {
      var defineMethod, kls, name, proto, _i, _len, _ref1;
      ...
      _ref1 = ["title", "leftButton", "rightButton"];
