(function() {
  ...
  define("kopi/ui/notification", function(require, exports, module) {
    var DuplicateNotificationError, bubbles, dialogs, exceptions, i18n, indicators, overlays, _ref;
    ...
    */
    ...
    DuplicateNotificationError = (function(_super) {
      ...
      function DuplicateNotificationError() {
        _ref = DuplicateNotificationError.__super__.constructor.apply(this, arguments);
        return _ref;
      }
    ...
    return {
      ...
      message: function() {
        ...
        return (_ref1 = bubbles.instance()).show.apply(_ref1, arguments);
      }
    };
  });
