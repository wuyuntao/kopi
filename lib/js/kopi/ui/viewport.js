(function() {
  ...
  define("kopi/ui/viewport", function(require, exports, module) {
    var $, Viewport, browser, exceptions, logger, logging, notification, viewportInstance, widgets, win;
    ...
    */
    ...
    Viewport = (function(_super) {
      ...
      */
      ...
      Viewport.prototype.onskeleton = function() {
        ...
        self._browser();
        self._resize(false);
        win.bind(cls.RESIZE_EVENT, function() {
    ...
    return {
      Viewport: Viewport,
      instance: function() {
        return viewportInstance || new Viewport();
      }
    };
  });
