(function() {
  ...
  define("kopi/utils/css", function(require, exports, module) {
    var $, browser, experimental, reMatrix, scaleClose, scaleOpen, settings, support, text, transform, transitionDuration, translateClose, translateOpen, vendorPrefix;
    $ = require("jquery");
    ...
    */
    ...
    $.fn.translate = function(x, y) {
      ...
      if (support.cssTransform) {
        return this.css(transform, "" + translateOpen + x + "px," + y + "px" + translateClose);
      } else {
        return this.css({
          left: x,
          top: y
