(function() {
  ...
  define("kopi/utils/events", function(require, exports, module) {
    var $, browser, defineMethod, delta, interval, last, name, now, onResize, settings, support, throttle, _i, _len, _ref;
    $ = require("jquery");
    ...
    exports.CLICK_EVENT = "click";
    exports.DOUBLE_CLICK_EVENT = "doubleclick";
