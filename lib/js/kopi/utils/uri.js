(function() {
  ...
  define("kopi/utils/uri", function(require, exports, module) {
    var $, absolute, array, base, baseURI, build, cur, current, decode, doc, emp, exceptions, join, loc, object, par, parse, reHost, rePath, reURL, redirect, relative, removeDotSegments, sep, text, unjoin, unparse;
    $ = require("jquery");
