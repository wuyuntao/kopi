    ...
    View = (function(_super) {
      ...
      */
      ...
      View.prototype.create = function(options, fn) {
        ...
        self.lock();
        if (fn) {
          self.on(cls.CREATED_EVENT, function(e) {
      ...
      */
      ...
      View.prototype.start = function(url, params, options, fn) {
        ...
        self.lock();
        if (fn) {
          self.on(cls.STARTED_EVENT, function(e) {
            return fn(false, self);
          });
        }
      ...
      */
      ...
      View.prototype.update = function(url, params, options, fn) {
        ...
        if (fn) {
          self.on(cls.UPDATED_EVENT, function(e) {
            return fn(false, this);
          });
        }
      ...
      */
      ...
      View.prototype.stop = function(options, fn) {
        ...
        self.lock();
        if (fn) {
          self.on(cls.STOPPED_EVENT, function(e) {
            return fn(false, self);
          });
        }
      ...
      */
      ...
      View.prototype.destroy = function(options, fn) {
        ...
        self.lock();
        if (fn) {
          self.on(cls.DESTROYED_EVENT, function(e) {
            return fn(false, self);
          });
        }
